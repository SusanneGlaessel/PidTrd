...
class PidTrdRunGetter {
 ...
 public:
  PidTrdRunGetter(const std::string& path, const std::string& mcdata_name, const std::string& jobId, const std::string& getter_file, TString getter_name) {
    path_ = path;
    mcdata_name_ = mcdata_name;
    jobId_ = jobId;
